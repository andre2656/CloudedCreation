...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link href="https://fonts.googleapis.com/css2?family=Charmonman:wght@700&family=Roboto&display=swap" rel="stylesheet">
        <!-- Styles -->
        <style>
        ...
        <style>
            ...
            .dropdown:hover .dropbtn {background-color: #457b9d; color: #4E8B9D;}
    ...
    <body class="mainContainer">
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0" id='container'>
           ...
           <div class="navRow">
                    ...
                    <div class= "pageTitle">
                        <p class="title">Clouded Creation</p>
                    </div>
                    <div class="login">
